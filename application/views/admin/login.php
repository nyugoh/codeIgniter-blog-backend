...
<div class="container-fluid" style="margin:48px 0">
	<div class="row" style="background-color: ;">
		<div class="well data-center col-sm-offset-3 col-sm-6" style=''>
			<form action="login" method="POST" role="form">
				...
				<div class="form-group col-sm-offset-2" >
					<button type="submit" class="btn btn-success btn-block" name="login">Login to Admin Panel</button>
					<p class="text-center">Forgot password?<a href="<?php echo base_url(); ?>admin/forgot"> reset</a></p>
					<p class="text-center">Already have not account? <a href="<?php echo base_url(); ?>admin/signup"> Signup</a></p>
				</div>
			</form>
		</div>
	</div>
